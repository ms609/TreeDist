...
reference](https://ms609.github.io/TreeDist/reference/index.html), or
can be viewed by typing `?FunctionName` in the R terminal.
...
- Construct [tree
  spaces](https://ms609.github.io/TreeDist/articles/treespace.md) to
