...
int16 degenerate_distance (int16 n_tip) {
  ...
  int16 nodes_in_full = (std::ceil(log2(n_tip / 3)) > 0) ? 
  ...
  int16 tips_in_full = std::pow(2, nodes_in_full);
