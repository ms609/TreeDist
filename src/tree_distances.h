...
extern double lg2_trees_matching_split(int a, int b),
  ...
  one_overlap (int a, int b, int n),
  one_overlap_notb (int a, int n_minus_b, int n),
  mpi (splitbit* a_state, splitbit* b_state, int n_tips, int in_a, int in_b, 
       double lg2_unrooted_n, int n_bins);
