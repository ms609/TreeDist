...
RcppExport SEXP _TreeDist_cons_phylo_info(SEXP treesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type trees(treesSEXP);
    rcpp_result_gen = Rcpp::wrap(cons_phylo_info(trees));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_TreeDist_cons_phylo_info", (DL_FUNC) &_TreeDist_cons_phylo_info, 1},
