...
#'   phylogenetic information distances, matching the structure returned by
#'   [`PhylogeneticInfoDistance()`].  Values near 0 indicate identical trees;
...
#' t1 <- BalancedTree(8)
#' t2 <- PectinateTree(8)
#' AdjustedPhylogeneticInfoDistance(t1, t1) # 0
