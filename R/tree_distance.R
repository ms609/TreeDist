...
#' @describeIn MutualPhylogeneticInfo Calculate variation of phylogenetic information from splits instead of trees.
#' @importFrom TreeSearch LnUnrooted.int LnRooted.int
#' @export
VariationOfPhylogeneticInfoSplits <- function (splits1, splits2, normalize = TRUE,
                                           reportMatching = FALSE) {
