...
#' arboreal or clustering information that two trees hold in common.
#' 
#' 
...
#' 
#' This proportion gives rise to the Mutual Arboreal Information similarity 
#' measure (`MutualArborealInfo`), and the complementary 
#' Variation of Arboreal Information distance metric
...
#' 
#' * `MutualArborealInfo`, `MutualClusteringInfo`: The information content of
#'  the least informative tree.
#'  To scale against the information content of the most informative tree, use
#' `normalize = pmax`.
#' 
#' * `VariationOfArborealInfo`, `VariationOfClusteringInfo`: The sum of the
#' (arboreal or clustering) information content of the two trees.
#' 
...
#'   # Non-arboreal matches contain clustering, but not arboreal, information
...
#' @describeIn MutualArborealInfo Variation of clustering information between two trees
#' @export
...
#' @describeIn MutualArborealInfo Mutual Clustering Information of two trees
#' @export
...
#' @describeIn MutualArborealInfo Calculate clustering information from splits instead of trees
#' @export
