...
# Remember to propogate changes here to T-d-m-e.Rmd
...
The SPR distance is normalized against a lower bound of its maximum possible value [@Allen2001].
...
```{R Tree-distance-distributions, echo=FALSE, message=FALSE, cache=TRUE, fig.asp=1, fig.width=7, out.width='90%', fig.align='center'}
...
toCorrelate <- c('vci', 'vpi', 'vmsi', 'nts', 'qd', 'msd', 'path', 'rf')
