...
PlotHist(d25['msd', ],  manyBreaks * max(dists['msd', ]),  'Matching Splits', border=cbPalette8[6])
PlotHist(d25['path', ],  manyBreaks * max(dists['path', ]),  'Path', border=cbPalette8[7])
PlotHist(d25['spr', ], 0:max(dists['spr', ]),  'SPR', border=cbPalette8[8])
