...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], 
  ...
  text(text_x, y <- y - 1, paste0(signif(treespace::treeDist(tr, ref), 4), 
                                  ' / ', (11L - 3L) * 2L), cex=0.8, pos=4)
...
write.tree(structure(moveOne, class='multiPhylo'), file=tempFileName)
qds <- AllPairsQuartetDistance(tempFileName)
xx <- file.remove(tempFileName)
