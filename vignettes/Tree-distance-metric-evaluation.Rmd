...
```{r 7-tip-trees-3, echo=FALSE, message=FALSE, cache=TRUE, fig.asp=5/4, fig.width=8.4, out.width='100%', fig.align='center'}
...
layout(matrix(seq_len(8*3), ncol=4, byrow=TRUE)[c(1, 3, 5, 2, 4, 6), ],
       heights = c(1, 2, 2, 1, 2, 2)*2, widths = rep(2, 4)*2)
par(oma=c(0, 0, 0, 0))

par(mar=c(0, 0.8, 4, 0.8))
