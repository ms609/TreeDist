...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], 
  ...
  text(text_x, y <- y - 1, cex=0.8, pos=4,
       round(TreeSearch::VariationOfArborealInfo(tr, ref, normalize = TRUE), 4))
  text(text_x, y <- y - 1, cex=0.8, pos=4,
       round(TreeSearch::VariationOfPartitionInfo(tr, ref, normalize = TRUE), 4))
  text(text_x, y <- y - 1, cex=0.8, pos=4,
       round(TreeSearch::VariationOfClusteringInfo(tr, ref, normalize = TRUE), 4))
  
  text(text_x, y <- y - 1, cex=0.8, pos=4,
       round(1 - TreeSearch::NyeTreeSimilarity(tr, ref, normalize = TRUE), 4))
...
PlotMDS(TreeSearch::MatchingSplitDistance(moveOne, moveOne), 'Mat. Spl. Dist')
...
random_arb_info <- TreeSearch::VariationOfArborealInfo(random_trees, pectinate_tree, normalize=TRUE)
pect_arb_info <- TreeSearch::VariationOfArborealInfo(pectinate_move1, pectinate_tree, normalize=TRUE)
random_par_info <- TreeSearch::VariationOfPartitionInfo(random_trees, pectinate_tree, normalize=TRUE)
pect_par_info <- TreeSearch::VariationOfPartitionInfo(pectinate_move1, pectinate_tree, normalize=TRUE)
pect_arb_info <- TreeSearch::VariationOfArborealInfo(pectinate_move1, pectinate_tree, normalize=TRUE)
random_clu_info <- TreeSearch::VariationOfClusteringInfo(random_trees, pectinate_tree, normalize=TRUE)
pect_clu_info <- TreeSearch::VariationOfClusteringInfo(pectinate_move1, pectinate_tree, normalize=TRUE)
