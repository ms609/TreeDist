---
title: "Calculate tree similarity with _TreeDist_"
...
distances with _TreeDist_.  If you get stuck, please 
[let me know](https://github.com/ms609/TreeDist/issues/new?title=Suggestion:+)
so I can improve this documentation.

## Loading trees

Instructions for loading phylogenetic trees into R can be found in a [separate vignette](https://ms609.github.io/TreeSearch/articles/load-trees.html).
...
against the total information content of all partitions.  
...
twoTrees <- structure(list(ape::rtree(11), ape::rtree(11)), class='multiPhylo')
threeTrees <- list(ape::rtree(11), ape::rtree(11), ape::rtree(11))
