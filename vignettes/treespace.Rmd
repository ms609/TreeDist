...
so is expected to contain some structure as we jump from one 'class' of tree to
another. 
...
That's a good start.  A lazy investigator would plot the first two dimensions
