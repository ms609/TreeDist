...
These clustering methods assume that clusters are similarly sized and regularly
shaped, and that all trees belong to a cluster.
These are often strong assumptions, particularly when analysing a Bayesian
posterior sample; in such cases, it may also be worth employing
[density based clustering](density-clustering.html).
...
- Explore [Density-based clustering](density-clustering.html)
