...
In this simple example we'll take a series of 200 trees from a list ordered by
...
library('TreeDist')
distances <- ClsuteringInfoDistance(trees)
```
...
## TODO PID on same trees to show MST & 2D are bad.
