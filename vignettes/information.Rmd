...
Because all outcomes are equiprobable, the entropy of the ensemble _X_ $H(X) = \sum\nolimits_{x\in X}P(x)\log_2{\frac{1}{P(x)}} = \log_2{|X|}$.

The split $S_1 =$ `AB|CDEF` is found in fifteen 6-leaf trees; this ensemble,
$X_1$, has an entropy of $\log_2{15} = 3.91\textrm{ bits}$.  For convenience,
let us denote this entropy as $H(S_1) = 3.91\textrm{ bits}$.
