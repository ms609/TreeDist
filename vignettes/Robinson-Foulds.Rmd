...
The simplicity of counting splits is appealing, but limiting: it assumes 
that all splits are equivalent, when they are not.
...
As a consequence, trees whose splits are less even will, on average, have
...
eight-leaf tree topologies that contain the split in question.
