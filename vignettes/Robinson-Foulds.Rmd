...
allocated a lower score of 2.12&nbsp;bits.  Contradictory pairings -- pairs of
splits that cannot exist on a single tree, such as `ABCDEFG|HI` - `ABCDFGH|EI` 
-- have no phylogenetic information in common.  (If it is permissible to 
acknowledge similarity between contradictory splits, 
