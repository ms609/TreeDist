...
### The problem with coherent matchings
...
_J_, yet receive zero similarity under coherent metrics.
...
non-coherent information-based tree distance metric that, as desired, assigns a
...
lines(x = x, y = vapply(x, JaccardRobinsonFoulds, tree1 = tree1, tree2 = tree2,
                        coherent = FALSE, 0), col = cbPalette8[5])
lines(x = x, y = vapply(x, JaccardRobinsonFoulds, tree1 = tree1, tree2 = tree2,
                        0), col = cbPalette8[4])

legend('right', c('Robinson-Foulds', 'Coherent', 'Non-coherent', 'Nye et al.'),
