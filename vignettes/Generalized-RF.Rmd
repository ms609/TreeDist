...
"#D55E00", "#CC79A7") # dput(Ternary::cbPalette8)
...
three elements (_F_, _I_ and _J_) must be moved before the splits are 
...
This approach scores each pair of splits according to the information 
content of the most information-rich split that is consistent with both
splits in the pair.
...
This measure can therefore be normalized against the sum of the phylogenetic
information content of all splits in each of the two input trees.
