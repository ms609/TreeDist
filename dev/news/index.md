...
- Add
  ...
  the largest clustering information distance attainable by a single
  nearest neighbour interchange on an *n*-leaf tree, derived
  analytically (normalized or not) rather than by sampling.
...
- [`MCITree()`](https://ms609.github.io/TreeDist/dev/reference/MCITree.md)
  selects the tree from a posterior sample with the highest total split
  information content — a Maximum Clade Information analogue of the
...
- [`HierarchicalMutualInformation()`](https://ms609.github.io/TreeDist/dev/reference/HierarchicalMutualInformation.md)
...
- [`Project()`](https://ms609.github.io/TreeDist/dev/reference/MapTrees.md)/[`ProjectionQuality()`](https://ms609.github.io/TreeDist/dev/reference/MappingQuality.md)
  re-named to
  [`MapTrees()`](https://ms609.github.io/TreeDist/dev/reference/MapTrees.md)/[`MappingQuality()`](https://ms609.github.io/TreeDist/dev/reference/MappingQuality.md).
