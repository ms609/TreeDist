...
- **[Martin R. Smith](https://smithlabdurham.github.io/)**. Author,
  maintainer, copyright holder, programmer.
  [](https://orcid.org/0000-0001-5660-1727)

- **Roy Jonker**. Programmer, copyright holder.  
  LAP algorithm

- **Yong Yang**. Contributor, copyright holder.  
  LAP algorithm
...
Source:
[`inst/CITATION`](https://github.com/ms609/TreeDist/blob/2.15.0/inst/CITATION)
...
Systematic Biology 71: 1255–1270. doi: 10.1093/sysbio/syab100
...
package version 2.15.0. Comprehensive R Archive Network, Vienna. doi:
10.32614/CRAN.package.TreeDist

    @Manual{TreeDist,
      title = {TreeDist: Distances between Phylogenetic Trees. R package version 2.15.0},
      author = {Martin R. Smith},
